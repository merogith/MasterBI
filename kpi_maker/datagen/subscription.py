"""Synthetic data generator for subscription businesses.
...
def _calibrated_book(profile, months, segments, growth, anomalies, params):
    ...
    only what a simulated pass measures — surviving logos, and the year-on-year
    growth implied by the MRR movements.
    """
    ...
    def simulate(rng, base_new, current_growth) -> Attempt:
        ...
        return Attempt(
            ...
            growth=yoy_growth(mrr, report_start),
            payload=(customers, movements, rng),
        )
